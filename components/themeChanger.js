...
export default function ThemeChanger() {
  ...
  return (
    <button
      ...
      type="button"
      className="flex items-center justify-center rounded-full bg-gray-200 p-3 ring-zinc-800 ring-offset-4 ring-offset-zinc-100 duration-200 ease-in-out hover:ring-2 dark:bg-gray-800 dark:ring-zinc-200 dark:ring-offset-gray-900"
